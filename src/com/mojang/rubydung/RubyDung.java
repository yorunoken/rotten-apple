...
public class RubyDung implements Runnable {
   ...
   public void init() throws LWJGLException, IOException {
      ...
      // initialize bad apple
      this.badApple = new BadApple(this.level);
   ...
   public void run() {
      try {
         this.init();
         // load the frames
         this.badApple.startLoadingFrames();
      ...
      int frames = 0;
       ...
       this.level.setTile(100, 43, 100, 1);
      try {
   ...
   public void render(float a) {
      ...
      while(Keyboard.next()) {
         if (Keyboard.getEventKey() == 28 && Keyboard.getEventKeyState()) {
            this.level.save();
         } else if (Keyboard.getEventKey() == 48 && Keyboard.getEventKeyState()) {
             // start the animation if the B key is pressed
             this.badApple.start();
         }
      }
